<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <x-nav-link :href="route('users.index')" :active="request()->routeIs('users.*')" class="ml-4">
                        {{ __('Data Pengguna') }}
                    </x-nav-link>
                        ...
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('tools.index')">
                                 ...
                                 <x-dropdown-link :href="route('tools.trash')">
                                    {{ __('Sampah / Tak Terpakai') }}
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-2 px-4 text-xs font-bold text-gray-500 uppercase border-t border-gray-100 mt-2">
                Aset & Perawatan
            </div>
