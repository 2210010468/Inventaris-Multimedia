<x-app-layout>
    ...
    {{-- MODAL UPLOAD --}}
<div v id="uploadModal" style="z-index: 9999; display: none;" class="fixed inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
