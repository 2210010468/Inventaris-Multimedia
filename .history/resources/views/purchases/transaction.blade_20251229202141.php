<x-app-layout>
    ...
    function openModal(element) {
        ...
        try {
            ...
            console.log('Data ID:', id); // Cek di console (F12)

            // Cek elemen Modal ada atau tidak
            const modal = document.getElementById('uploadModal');
            const form = document.getElementById('evidenceForm');
            
            if (!modal || !form) {
                alert('Error: Elemen Modal atau Form tidak ditemukan! Cek ID HTML.');
                return;
            }

            // SET URL
            // Hati-hati di sini. Jika route salah, Laravel akan error 500.
            // Kita pakai cara aman dulu untuk tes:
            const baseUrl = "{{ url('/purchases') }}"; // Asumsi URL dasar
            form.action = baseUrl + "/" + id + "/evidence"; 
            ...
            alert('Terjadi error script: ' + error.message);
        }
    }
